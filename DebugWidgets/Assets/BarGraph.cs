...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (Min < 0) { 
            ...
            BarTransform.localPosition = new Vector3(width / 2, BarTransform.localPosition.y, BarTransform.localPosition.z);
        }
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        float scaledValue = signedDisplay ? value / 2 : value;
        BarTransform.localScale = new Vector3(scaledValue * BarTransform.localScale.y, BarTransform.localScale.y, BarTransform.localScale.z);
    }
    ...
    public static BarGraph Find(string name, Vector2 position, float min, float max)
    {
        ...
        // "don't rotate it".
        GameObject go = Instantiate(Prefab, canvas.transform);  // Change null to a call to Instantiate
        go.transform.position = position;
        go.transform.rotation = Quaternion.identity; // No rotation
        ...
        BarGraph bgComponent = go.GetComponent<BarGraph>();  // Change null here
